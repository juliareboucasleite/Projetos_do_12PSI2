<?php
	...
	try
	{
		...
		$resultado = $db->query('SELECT musicas.id, titulo, ano_lancamento, duracao_segundos, musicos.nome FROM musicas, musicos WHERE musicas.ID = 1 AND musicas.musico_id = musicos.id');
...
<body>
	<main class="container">
		<h1 class="h3 mb-4">Exercício 3</h1>
		...
		<form class="row g-3">
            ...
            <div class="col-12">
				<label for="nome" class="form-label">Músico(a)</label>
				<input type="text" class="form-control" id="nome" name="nome" value="<?= $musica['nome'] ?>" readonly disabled>
			</div>	
